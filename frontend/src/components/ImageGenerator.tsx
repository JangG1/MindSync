      ...
      <div className="igBody">
        <div className="createInputBox">
          ...
          <div className="createDesc">
            ...
            1️⃣ 이미지 설명 입력 <br />
            <li>
              생성하고 싶은 이미지를 설명하는 단어 또는 문장을 입력하세요.
            </li>
            <li>
              예시: "나무", "콜라", "접시 위의 케이크", "해변에서 맥주를 마시고
              있는 미국인".
            </li>
            <br />
            2️⃣ 자동 번역 (한글 → 영어) <br />
            ...
            ⚠️ 주의사항
            <li>
              명확하고 자세한 설명일수록 더 좋은 이미지를 얻을 수 있습니다.
            </li>
            <li>
            ...
            <li style={{ color: "red" }}>
              계속해서 실패할 경우 잠시 시간을 둔 후 다양한 키워드로 재시도하는것을 추천합니다.
            </li>
